...
<?php echo form_open_multipart('view/addcustomerdetail'); ?>
        ...
        <table >
            ...
            <tr>
                ...
                <td><input type="radio" name="title" value="Mr." />  Mr. &nbsp; <input type="radio" name="title" value="Mrs." /> Mrs. &nbsp; <input type="radio" name="title" value="Miss." /> Miss. &nbsp; <input type="radio" name="title" value="Ms." /> Ms. &nbsp; *</td>
            ...
            <tr>
                <td colspan="2"><input class="intextd"  type="text" name="dobyear" placeholder="Year" id="db_y" />
                    ...
                    <input class="intextd" type="text" name="dobday" placeholder="Day" id="db_d" /><img src="<?php echo base_url() . "content/images/calender.png" ?>" id="db" />  </td>
                <td> </td>

            </tr>
            <tr>
                <td>Current Address</td><td></td>
            </tr>
        ...
        <div class="cidentity">
            <label id="clpid">  Customer Identity </label> <hr/>
            ...
            foreach ($array as $data) {
                ...
                <table  style="float: left; margin-right: 3%; ">
                    <tr>
                        <td colspan="3" style="text-align:center"  >  <?php echo $data; ?>  <input type="hidden" name="<?php echo $data; ?>" value="<?php echo $data; ?>"/></td>
                    </tr>
                    <tr>
