...
<?php echo form_open_multipart('view/addSendTransaction_get'); ?>
        ...
        <table >
            <tr>
                <td> <input class="intexth"   type="text" name="ref_number" placeholder="Refrence Number" required="required" value="<?php echo set_value('ref_number'); ?>" /> </td>
...
foreach ($query as $data) {
    ?>
        ...
        <div class="cidentitytran">
            ...
            <div class="t_left">
                <label id="clpid"> <b > Sender Information  </b></label> <hr/>
                <table>
                    <tr>
                        <td>
                            <input type="radio" name="title" value="Mr." <?php if ($title == 'Mr.') { ?> checked <?php } ?> /> Mr. &nbsp; 
                            <input type="radio" name="title" value="Mrs."<?php if ($title == 'Mrs.') { ?> checked <?php } ?> /> Mrs. &nbsp; 
                            <input type="radio" name="title" value="Miss."<?php if ($title == 'Miss.') { ?> checked <?php } ?> /> Miss. &nbsp; 
                            <input type="radio" name="title" value="Ms."<?php if ($title == 'Ms.') { ?> checked <?php } ?> /> Ms.
                        </td>
                    </tr>
                </table>
                <br/>
            ...
            <div class="t_right">
                <label id="clpid"> <b > Receiver Information  </b></label> <hr/> 
                <table>
                    <tr>
                        <td>
                            <input type="radio" name="rtitle" value="Mr." required="required" /> Mr. &nbsp; 
                            <input type="radio" name="rtitle" value="Mrs." required="required" /> Mrs. &nbsp;
                            <input type="radio" name="rtitle" value="Miss." required="required" /> Miss. &nbsp; 
                            <input type="radio" name="rtitle" value="Ms." required="required" /> Ms.
                        </td>
                    </tr>
                </table>
                ...
                <br/>
                <input class="intexth" type="text" name="r_name" placeholder="Receiver Name" value="<?php echo set_value('r_name'); ?>" required="required" /> <br/> <br/>
                <input class="intexth" type="text" name="r_add" placeholder="Receiver Address" value="<?php echo set_value('r_add'); ?>" required="required" /> <br/> <br/>
                <input class="intexth" type="text"  name="r_number" placeholder="Contact Number" value="<?php echo set_value('r_number'); ?>" required="required" /> <br/> <br/>
                ...
                <script>
                    ...
                    $("#tAmount").click(function(){
                     var rAmount =  $("#rAmout").val();
                      var sAmount = $("#sAmount").val();
                      tAmount = Number(rAmount) + Number(sAmount);
                       $("#tAmount").val(tAmount);
                    });
                  }); 
                </script>
                <input class="intexth" type="text" name="r_idnumber" placeholder="Id Number" required="required" /> 
                <br/> <br/>
                <input class="intexth" type="text" name="r_amount" placeholder="Amount" required="required" id="rAmout"/> <br/> <br/>
                <input class="intexth" type="text" name="r_coll_amount" placeholder="Service Charge"  required="required" id="sAmout" /> <br/> <br/>
                <input class="intexth" type="text" name="total_amount" placeholder="Total Amount"  required="required" id="tAmount" /> <br/> <br/>
                <input class="amountFigure" type="text"  name="r_amt_word" placeholder="Amount In Figure" required="required" /> <br/> <br/>
            </div>
            <div class="clear"> </div>
